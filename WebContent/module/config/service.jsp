		...
		jQuery(document).ready(function() {   
			try {
				...
				*/
				...
				jQuery("#list").jqGrid({
				  caption: '服务节点列表',
				  url: contextPath + '/testing/demo/service.xml', // 'api.do?pageAction=module.config.app.queryAppList', 
				  datatype: 'xml',
				  mtype: 'POST',
				  xmlReader : { 
					  root:"rows", 
				  ...
				  colNames:['服务ID', '服务名称', '主机ID', '共享模式', '服务类型', '服务状态', '备注'],
				  colModel :[ 
				    {name:'service_id', index:'service_id', hidden:true, editable:true, editrules:{edithidden:true, required:true}, width:120}, 
				    {name:'service_name', index:'service_name', editable:true, sortable:false, width:120}, 
				    {name:'host_id', index:'host_id', 
					    editable:true, 
				    ...
				    {name:'share_mode', index:'share_mode', editable:true,
					    ...
					    width:120, align:'center'}, 
					{name:'service_type', index:'service_type', editable:true, 
							edittype:'select', formatter:'select', 
						    editoptions:{value:"memcached:Memcached;db_pool_mysql:MySQL连接池;com:组件服务器"}, sortable:false, width:120}, 
				    {name:'service_state', index:'service_state', editable:true, 
							    edittype:'select', formatter:'select', 
