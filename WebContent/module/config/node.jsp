			...
			try {
				...
				*/
				...
				jQuery("#list").jqGrid({
				  ...
				  colNames:['节点ID', '节点名称','共享模式', '节点类型', '节点状态', '备注'],
				  colModel :[ 
				    {name:'node_id', index:'node_id',  editable:true, editrules:{edithidden:true, required:true}, width:120}, 
				    {name:'node_name', index:'node_name', editable:true, sortable:false, width:120}, 
				    {name:'share_mode', index:'share_mode', editable:true,
					    edittype:'select', formatter:'select', 
					    editoptions:{value:"0:保留;1:独占;2:共享"}, sortable:false,
					    width:120, align:'center'}, 
					{name:'node_type', index:'node_type', editable:true, 
							edittype:'select', formatter:'select', 
						    editoptions:{value:"db:数据库;db_proxy:数据访问代理;cache:分布式换成;dfs:分布式文件存储"}, sortable:false, width:120}, 
				    {name:'node_state', index:'node_state', editable:true, 
							    edittype:'select', formatter:'select', 
